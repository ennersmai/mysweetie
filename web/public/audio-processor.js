...
const BARGE_IN_MULTIPLIER = 2.0; // Mic must be this many times louder than TTS to barge in (balanced: 100% louder than echo)
...
class AudioProcessor extends AudioWorkletProcessor {
  ...
  constructor(options) {
    ...
    this.learnedEchoRatio = 0.5; // Optimistic default - will be learned during calibration (50% echo ratio)
